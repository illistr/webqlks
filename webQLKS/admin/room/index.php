<?php
    ...
    $sql = "select Room.*, Category.name as category_name from Room left join Category on Room.category_id = Category.id where Room.deleted = 0";
	$data = executeResult($sql);
?>

<div class="row" style="margin-top: 50px;">
	<div class="col-md-12 table-responsive">
		<h3>Quản Lý Phòng Thuê</h3>
...
<script type="text/javascript">
	function deleteProduct(id) {
		option = confirm('Bạn có chắc chắn muốn xoá phòng này không?')
		if(!option) return;
