<?php
	...
	$id = getGet('id');
	if($id != '' && $id > 0) {
		$sql = "select * from Room where id = '$id' and deleted = 0";
		$userItem = executeResult($sql, true);
		if($userItem != null) {
			$thumbnail = $userItem['thumbnail'];
			$title = $userItem['title'];
			$status=$userItem['statuss'];
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-md-3 col-12" style="border: solid grey 1px; padding-top: 10px; padding-bottom: 10px;">
						...
						<div class="form-group">
						  <label for="usr">Danh Mục Phòng:</label>
